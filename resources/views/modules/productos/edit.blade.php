                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('productos.update', $item->id) }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" required id="nombre" name="nombre"
                                            value="{{ $item->nombre }}" placeholder="Ej: Laptop Dell XPS 15">
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" required id="stock" name="stock" min="0"
                                            value="{{ $item->stock }}">
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="0.01" min="0" class="form-control" required id="precio_compra" name="precio_compra"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" step="0.01" min="0" class="form-control" required id="precio_venta" name="precio_venta"
                                ...
                                <button type="submit" class="btn btn-warning mt-3">
                                    <i class="fa-solid fa-pen-to-square"></i> Actualizar Producto
                                </button>
